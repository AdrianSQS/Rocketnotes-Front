...
export function New() {
  ...
  async function handleNewNote() {
    ...
    try {
      ...
      if (newLink) {
        return alert(
          "Link não adicionado. Clique para adicionar ou deixe o campo vazio."
        );
      }

      if (newTag) {
        return alert(
          "Tag não adicionada. Clique para adicionar ou deixe o campo vazio."
        );
      }
    ...
    <Container>
      ...
      <main>
        <Form>
          ...
          <Button title="Salvar" onClick={handleNewNote} loading={loading} />
        </Form>
      </main>
    </Container>
  );
